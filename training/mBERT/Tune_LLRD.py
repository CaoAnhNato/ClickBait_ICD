"""
Tune_LLRD.py
Fine-tune bert-base-multilingual-cased for Vietnamese Clickbait Detection using Layer-wise Learning Rate Decay.

Output (per run) written to result/results_mBERT/llrd_base/:
...
def main():
    parser = argparse.ArgumentParser(
        description="Fine-tune bert-base-multilingual-cased using LLRD."
    )
    ...
    output_dir = "result/results_mBERT/llrd_base"
