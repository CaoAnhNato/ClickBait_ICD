"""
Tune_LLRD.py
Fine-tune xlm-roberta-base for Vietnamese Clickbait Detection using Layer-wise Learning Rate Decay.

Output (per run) written to result/results_XLMR/llrd_base/:
...
def main():
    parser = argparse.ArgumentParser(
        description="Fine-tune xlm-roberta-base using LLRD."
    )
    ...
    output_dir = "result/results_XLMR/llrd_base"
