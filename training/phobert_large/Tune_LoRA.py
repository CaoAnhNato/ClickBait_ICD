"""
Tune_LoRA.py
Fine-tune vinai/phobert-large using LoRA (Low-Rank Adaptation).

Output (per run) written to result/results_phobert_large/lora_base/:
...
def main():
    parser = argparse.ArgumentParser(description="Fine-tune vinai/phobert-large with LoRA.")
    ...
    output_dir = "result/results_phobert_large/lora_base"
    ...
    # ── Model + LoRA ───────────────────────────────────────────────────────────
    print(f">>> Initializing vinai/phobert-large with LoRA...")
