"""
Tune_LLRD.py
Fine-tune vinai/phobert-large for Vietnamese Clickbait Detection using Layer-wise Learning Rate Decay.

Output (per run) written to result/results_phobert_large/llrd_base/:
...
def main():
    parser = argparse.ArgumentParser(
        description="Fine-tune vinai/phobert-large using LLRD."
    )
    ...
    output_dir = "result/results_phobert_large/llrd_base"
