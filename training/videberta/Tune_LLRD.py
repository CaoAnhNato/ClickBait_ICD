"""
Tune_LLRD.py
Fine-tune Fsoft-AIC/videberta-base for Vietnamese Clickbait Detection using Layer-wise Learning Rate Decay.

Output (per run) written to result/results_videberta/llrd_base/:
...
def main():
    parser = argparse.ArgumentParser(
        description="Fine-tune Fsoft-AIC/videberta-base using LLRD."
    )
    ...
    output_dir = "result/results_videberta/llrd_base"
    ...
    if args.freeze_layers > 0:
        ...
        for name, param in model.named_parameters():
            ...
            elif name.startswith("deberta.encoder.layer."):
