"""
Tune_LLRD.py
Fine-tune FPTAI/vibert-base-cased for Vietnamese Clickbait Detection using Layer-wise Learning Rate Decay.

Output (per run) written to result/results_viBERT/llrd_base/:
...
def main():
    parser = argparse.ArgumentParser(
        description="Fine-tune FPTAI/vibert-base-cased using LLRD."
    )
    ...
    output_dir = "result/results_viBERT/llrd_base"
