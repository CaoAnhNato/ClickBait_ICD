"""
Tune_LoRA.py
Fine-tune FPTAI/vibert-base-cased using LoRA (Low-Rank Adaptation).

Output (per run) written to result/results_viBERT/lora_base/:
...
def main():
    parser = argparse.ArgumentParser(description="Fine-tune FPTAI/vibert-base-cased with LoRA.")
    ...
    output_dir = "result/results_viBERT/lora_base"
    ...
    # ── Model + LoRA ───────────────────────────────────────────────────────────
    print(f">>> Initializing FPTAI/vibert-base-cased with LoRA...")
