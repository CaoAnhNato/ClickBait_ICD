"""
Tune_LoRA.py
Fine-tune vinai/phobert-base-v2 using LoRA (Low-Rank Adaptation).

Output (per run) written to result/results_phobert_base_v2/lora_base/:
...
def main():
    parser = argparse.ArgumentParser(description="Fine-tune vinai/phobert-base-v2 with LoRA.")
    ...
    output_dir = "result/results_phobert_base_v2/lora_base"
    ...
    # ── Model + LoRA ───────────────────────────────────────────────────────────
    print(f">>> Initializing vinai/phobert-base-v2 with LoRA...")
